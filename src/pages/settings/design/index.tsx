...
class Index extends React.Component<any, any> {
  ...
  Canvas = ({ children }: { children: ReactNode }) => {
    ...
    return <div style={classes.Canvas}>{children}</div>;
  };
    ...
    return (
      <div>
        ...
        <TextField
          label={"x"}
          variant={"outlined"}
          value={elementTemp.type}
          onBlur={() => {
            this.setState({
              element: [{ type: "Button", XPosition: 100, YPosition: 0 }],
            });
          }}
        ></TextField>
        <TextField
  ...
  render() {
    return (
      <div key={this.state.elements.length}>
        <this.Header />

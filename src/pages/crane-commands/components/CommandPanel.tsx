 ...
 * @LastEditTime: 2021-10-12 16:40:51
...
const CommandFilter = () => {
	...
	const handleSelect =
		(field: 'bay' | 'orderType') => (selectedValue: string) => {
			console.log(field)
	...
	return (
		<div>
			<Grid container spacing={4}>
				<Grid item xs={3}>
					库区：
					<MySelect options={bayIds} onSelect={handleSelect('bay')}></MySelect>
				</Grid>
				<Grid item xs={3}>
					作业类型：
					<MySelect
						options={bayIds}
						onSelect={handleSelect('orderType')}
					></MySelect>
				</Grid>
				<Grid item xs={3}>
